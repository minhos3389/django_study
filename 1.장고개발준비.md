...
![가상환경문제](https://wikidocs.net/images/page/70588/1-03_1.png) <br>
파이썬 가상환경은 파이썬 프로젝트를 진행할 때 독립된 환경을 만들어 주는 도구이다.

![가상환경사용이유](https://wikidocs.net/images/page/70588/1-03_2.png) <br>
...
![개발 서버 구동](https://wikidocs.net/images/page/72377/1-04_1.png) <br>
...
![로컬사이트접속불가](https://wikidocs.net/images/page/72377/1-04_2.png) <br>
...
- 언어와 시간을 한국 값으로 설정해준다.
    - LANGUAGE_CODE를 en-us에서 ko-kr로 수정하고 TIME_ZONE을 UTC에서 Asia/Seoul로 수정한다.
```
LANGUAGE_CODE = 'ko-kr'
