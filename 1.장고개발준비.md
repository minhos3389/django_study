...
### 파이썬 설치.
[www.python.org](파이썬 공식홈페이지) 으로 이동해서 파이썬을 운영체제에 맞추어 다운로드한다.
...
![가상환경문제](./image_folder/venv1.png)
파이썬 가상환경은 파이썬 프로젝트를 진행할 때 독립된 환경을 만들어 주는 도구이다.

![가상환경사용이유](./image_folder/venv2.png)
...
### 5. 장고 프로젝트 내용물 확인하기
![장고 디렉터리 내용물](./image_folder/django_directory.png)
...
![로컬사이트접속불가](./image_folder/localsite_connection_error.png)
